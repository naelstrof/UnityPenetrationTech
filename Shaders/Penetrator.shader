...
Shader "PenetrationTech/Standard/Penetrator"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float temp_output_1_0_g1019 = saturate( ( abs( ( dotResult42_g979 - VisibleLength25_g979 ) ) / ( DickLength19_g979 * BulgePercentage37_g979 ) ) );
			float temp_output_94_0_g979 = sqrt( ( 1.0 - ( temp_output_1_0_g1019 * temp_output_1_0_g1019 ) ) );
			...
			float temp_output_1_0_g1009 = saturate( ( abs( ( dotResult32_g979 - ( DickLength19_g979 * _PenetratorCumProgress ) ) ) / ( DickLength19_g979 * BulgePercentage37_g979 ) ) );
			...
			float temp_output_42_0_g1010 = ( dotResult177_g979 / temp_output_178_0_g979 );
			float temp_output_26_0_g1011 = temp_output_42_0_g1010;
			float temp_output_19_0_g1011 = ( 1.0 - temp_output_26_0_g1011 );
			float3 temp_output_8_0_g1010 = DickOrigin16_g979;
			...
			float3 temp_output_9_0_g1010 = ( DickOrigin16_g979 + ( DickForward18_g979 * temp_output_396_0_g979 * 0.25 ) );
			...
			float3 temp_output_10_0_g1010 = ( OrifacePosition170_g979 + ( OrifaceNormal155_g979 * 0.25 * temp_output_396_0_g979 ) );
			float3 temp_output_11_0_g1010 = OrifacePosition170_g979;
			float temp_output_1_0_g1013 = temp_output_42_0_g1010;
			float temp_output_8_0_g1013 = ( 1.0 - temp_output_1_0_g1013 );
			float3 temp_output_3_0_g1013 = temp_output_9_0_g1010;
			...
			float3 temp_output_5_0_g1010 = DickRight184_g979;
			float dotResult15_g1010 = dot( temp_output_2_0_g1010 , temp_output_5_0_g1010 );
			float3 temp_output_65_0_g1010 = cross( normalizeResult29_g1014 , normalizeResult27_g1014 );
			float dotResult18_g1010 = dot( temp_output_2_0_g1010 , temp_output_4_0_g1010 );
			...
			float temp_output_42_0_g1024 = lerpResult416_g979;
			float temp_output_26_0_g1025 = temp_output_42_0_g1024;
			float temp_output_19_0_g1025 = ( 1.0 - temp_output_26_0_g1025 );
			float3 temp_output_8_0_g1024 = OrifacePosition170_g979;
			...
			float3 temp_output_9_0_g1024 = OrifaceOutPosition1183_g979;
			...
			float3 temp_output_10_0_g1024 = OrifaceOutPosition2182_g979;
			...
			float3 temp_output_11_0_g1024 = OrifaceOutPosition3175_g979;
			float temp_output_1_0_g1027 = temp_output_42_0_g1024;
			float temp_output_8_0_g1027 = ( 1.0 - temp_output_1_0_g1027 );
			float3 temp_output_3_0_g1027 = temp_output_9_0_g1024;
			float3 temp_output_4_0_g1027 = temp_output_10_0_g1024;
			float3 temp_output_7_0_g1026 = ( ( 3.0 * temp_output_8_0_g1027 * temp_output_8_0_g1027 * ( temp_output_3_0_g1027 - temp_output_8_0_g1024 ) ) + ( 6.0 * temp_output_8_0_g1027 * temp_output_1_0_g1027 * ( temp_output_4_0_g1027 - temp_output_3_0_g1027 ) ) + ( 3.0 * temp_output_1_0_g1027 * temp_output_1_0_g1027 * ( temp_output_11_0_g1024 - temp_output_4_0_g1027 ) ) );
			float3 normalizeResult27_g1028 = normalize( temp_output_7_0_g1026 );
			float3 temp_output_4_0_g1024 = DickUp172_g979;
			float3 temp_output_10_0_g1026 = temp_output_4_0_g1024;
			float3 temp_output_3_0_g1024 = DickForward18_g979;
			float3 temp_output_13_0_g1026 = temp_output_3_0_g1024;
			float dotResult33_g1026 = dot( temp_output_7_0_g1026 , temp_output_10_0_g1026 );
			float3 lerpResult34_g1026 = lerp( temp_output_10_0_g1026 , -temp_output_13_0_g1026 , saturate( dotResult33_g1026 ));
			float dotResult37_g1026 = dot( temp_output_7_0_g1026 , -temp_output_10_0_g1026 );
			float3 lerpResult40_g1026 = lerp( lerpResult34_g1026 , temp_output_13_0_g1026 , saturate( dotResult37_g1026 ));
			float3 normalizeResult42_g1026 = normalize( lerpResult40_g1026 );
			float3 normalizeResult31_g1028 = normalize( normalizeResult42_g1026 );
			float3 normalizeResult29_g1028 = normalize( cross( normalizeResult27_g1028 , normalizeResult31_g1028 ) );
			float3 temp_output_65_22_g1024 = normalizeResult29_g1028;
			float3 temp_output_2_0_g1024 = ( originalPosition126_g979 - DickOrigin16_g979 );
			float3 temp_output_5_0_g1024 = DickRight184_g979;
			float dotResult15_g1024 = dot( temp_output_2_0_g1024 , temp_output_5_0_g1024 );
			float3 temp_output_65_0_g1024 = cross( normalizeResult29_g1028 , normalizeResult27_g1028 );
			float dotResult18_g1024 = dot( temp_output_2_0_g1024 , temp_output_4_0_g1024 );
			float temp_output_208_0_g979 = saturate( sign( temp_output_152_0_g979 ) );
			float3 lerpResult221_g979 = lerp( ( ( ( temp_output_19_0_g1011 * temp_output_19_0_g1011 * temp_output_19_0_g1011 * temp_output_8_0_g1010 ) + ( temp_output_19_0_g1011 * temp_output_19_0_g1011 * 3.0 * temp_output_26_0_g1011 * temp_output_9_0_g1010 ) + ( 3.0 * temp_output_19_0_g1011 * temp_output_26_0_g1011 * temp_output_26_0_g1011 * temp_output_10_0_g1010 ) + ( temp_output_26_0_g1011 * temp_output_26_0_g1011 * temp_output_26_0_g1011 * temp_output_11_0_g1010 ) ) + ( temp_output_65_22_g1010 * dotResult15_g1010 ) + ( temp_output_65_0_g1010 * dotResult18_g1010 ) ) , ( ( ( temp_output_19_0_g1025 * temp_output_19_0_g1025 * temp_output_19_0_g1025 * temp_output_8_0_g1024 ) + ( temp_output_19_0_g1025 * temp_output_19_0_g1025 * 3.0 * temp_output_26_0_g1025 * temp_output_9_0_g1024 ) + ( 3.0 * temp_output_19_0_g1025 * temp_output_26_0_g1025 * temp_output_26_0_g1025 * temp_output_10_0_g1024 ) + ( temp_output_26_0_g1025 * temp_output_26_0_g1025 * temp_output_26_0_g1025 * temp_output_11_0_g1024 ) ) + ( temp_output_65_22_g1024 * dotResult15_g1024 ) + ( temp_output_65_0_g1024 * dotResult18_g1024 ) ) , temp_output_208_0_g979);
			float3 temp_output_42_0_g1020 = DickForward18_g979;
			float NonVisibleLength165_g979 = ( temp_output_11_0_g979 * _PenetratorLength );
			float3 temp_output_52_0_g1020 = ( ( temp_output_42_0_g1020 * ( ( NonVisibleLength165_g979 - OrifaceLength34_g979 ) - DickLength19_g979 ) ) + ( originalPosition126_g979 - DickOrigin16_g979 ) );
			float dotResult53_g1020 = dot( temp_output_42_0_g1020 , temp_output_52_0_g1020 );
			float temp_output_1_0_g1022 = 1.0;
			float temp_output_8_0_g1022 = ( 1.0 - temp_output_1_0_g1022 );
			float3 temp_output_3_0_g1022 = OrifaceOutPosition1183_g979;
			float3 temp_output_4_0_g1022 = OrifaceOutPosition2182_g979;
			float3 temp_output_7_0_g1021 = ( ( 3.0 * temp_output_8_0_g1022 * temp_output_8_0_g1022 * ( temp_output_3_0_g1022 - OrifacePosition170_g979 ) ) + ( 6.0 * temp_output_8_0_g1022 * temp_output_1_0_g1022 * ( temp_output_4_0_g1022 - temp_output_3_0_g1022 ) ) + ( 3.0 * temp_output_1_0_g1022 * temp_output_1_0_g1022 * ( OrifaceOutPosition3175_g979 - temp_output_4_0_g1022 ) ) );
			float3 normalizeResult27_g1023 = normalize( temp_output_7_0_g1021 );
			float3 temp_output_85_23_g1020 = normalizeResult27_g1023;
			float3 temp_output_4_0_g1020 = DickUp172_g979;
			float dotResult54_g1020 = dot( temp_output_4_0_g1020 , temp_output_52_0_g1020 );
			float3 temp_output_10_0_g1021 = temp_output_4_0_g1020;
			float3 temp_output_13_0_g1021 = temp_output_42_0_g1020;
			float dotResult33_g1021 = dot( temp_output_7_0_g1021 , temp_output_10_0_g1021 );
			float3 lerpResult34_g1021 = lerp( temp_output_10_0_g1021 , -temp_output_13_0_g1021 , saturate( dotResult33_g1021 ));
			float dotResult37_g1021 = dot( temp_output_7_0_g1021 , -temp_output_10_0_g1021 );
			float3 lerpResult40_g1021 = lerp( lerpResult34_g1021 , temp_output_13_0_g1021 , saturate( dotResult37_g1021 ));
			float3 normalizeResult42_g1021 = normalize( lerpResult40_g1021 );
			float3 normalizeResult31_g1023 = normalize( normalizeResult42_g1021 );
			float3 normalizeResult29_g1023 = normalize( cross( normalizeResult27_g1023 , normalizeResult31_g1023 ) );
			float3 temp_output_85_0_g1020 = cross( normalizeResult29_g1023 , normalizeResult27_g1023 );
			float3 temp_output_43_0_g1020 = DickRight184_g979;
			float dotResult55_g1020 = dot( temp_output_43_0_g1020 , temp_output_52_0_g1020 );
			float3 temp_output_85_22_g1020 = normalizeResult29_g1023;
			float temp_output_222_0_g979 = saturate( sign( ( temp_output_157_0_g979 - 1.0 ) ) );
			float3 lerpResult224_g979 = lerp( lerpResult221_g979 , ( ( ( dotResult53_g1020 * temp_output_85_23_g1020 ) + ( dotResult54_g1020 * temp_output_85_0_g1020 ) + ( dotResult55_g1020 * temp_output_85_22_g1020 ) ) + OrifaceOutPosition3175_g979 ) , temp_output_222_0_g979);
			...
			v.vertex.w = 1;
			float3 temp_output_21_0_g1010 = VertexNormal259_g979;
			float dotResult55_g1010 = dot( temp_output_21_0_g1010 , temp_output_3_0_g1010 );
			float dotResult56_g1010 = dot( temp_output_21_0_g1010 , temp_output_4_0_g1010 );
			float dotResult57_g1010 = dot( temp_output_21_0_g1010 , temp_output_5_0_g1010 );
			float3 normalizeResult31_g1010 = normalize( ( ( dotResult55_g1010 * normalizeResult27_g1014 ) + ( dotResult56_g1010 * temp_output_65_0_g1010 ) + ( dotResult57_g1010 * temp_output_65_22_g1010 ) ) );
			float3 temp_output_21_0_g1024 = VertexNormal259_g979;
			float dotResult55_g1024 = dot( temp_output_21_0_g1024 , temp_output_3_0_g1024 );
			float dotResult56_g1024 = dot( temp_output_21_0_g1024 , temp_output_4_0_g1024 );
			float dotResult57_g1024 = dot( temp_output_21_0_g1024 , temp_output_5_0_g1024 );
			float3 normalizeResult31_g1024 = normalize( ( ( dotResult55_g1024 * normalizeResult27_g1028 ) + ( dotResult56_g1024 * temp_output_65_0_g1024 ) + ( dotResult57_g1024 * temp_output_65_22_g1024 ) ) );
			float3 lerpResult227_g979 = lerp( normalizeResult31_g1010 , normalizeResult31_g1024 , temp_output_208_0_g979);
			float3 temp_output_24_0_g1020 = VertexNormal259_g979;
			float dotResult61_g1020 = dot( temp_output_42_0_g1020 , temp_output_24_0_g1020 );
			float dotResult62_g1020 = dot( temp_output_4_0_g1020 , temp_output_24_0_g1020 );
			float dotResult60_g1020 = dot( temp_output_43_0_g1020 , temp_output_24_0_g1020 );
			float3 normalizeResult33_g1020 = normalize( ( ( dotResult61_g1020 * temp_output_85_23_g1020 ) + ( dotResult62_g1020 * temp_output_85_0_g1020 ) + ( dotResult60_g1020 * temp_output_85_22_g1020 ) ) );
			float3 lerpResult233_g979 = lerp( lerpResult227_g979 , normalizeResult33_g1020 , temp_output_222_0_g979);
...
/*ASEBEGIN
Version=18912
259;328;1436;584;-6227.791;1796.961;2.675143;True;False
...
ASEEND*/
//CHKSM=C12CA3025F044F479E343F54D0042500A6193D6C