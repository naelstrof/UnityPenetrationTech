	...
	LOD 100
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float3 appendResult19 = (float3(( dotResult22 / _MaxLength ) , ( ( temp_output_14_0 - _AngleOffset ) / ( 2.0 * UNITY_PI ) ) , 0.0));
...
/*ASEBEGIN
Version=18912
115;219;2560;1127;1941.103;1322.288;1.318618;True;True
...
ASEEND*/
//CHKSM=80D2D8025148C0EBE89D89136605929C06F2AC31