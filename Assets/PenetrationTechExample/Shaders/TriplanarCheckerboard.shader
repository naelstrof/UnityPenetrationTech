	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 FinalUV13_g1 = ( float2( 1,1 ) * ( 0.5 + (WorldPosition).xz ) );
				...
				float2 FinalUV13_g2 = ( float2( 1,1 ) * ( 0.5 + (WorldPosition).zy ) );
				...
				float2 FinalUV13_g3 = ( float2( 1,1 ) * ( 0.5 + (WorldPosition).xy ) );
				...
				float3 Albedo = saturate( ( ( lerpResult73_g1 * abs( dotResult16 ) ) + ( lerpResult73_g2 * abs( dotResult21 ) ) + ( lerpResult73_g3 * abs( dotResult31 ) ) ) ).rgb;
...
/*ASEBEGIN
Version=18912
587;309;1712;979;1380.76;177.6384;1.15305;True;True
...
ASEEND*/
//CHKSM=938C72F2736243AC7B3531C26BAA9E199FB8E386