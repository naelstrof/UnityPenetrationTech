Shader /*ase_name*/ "Hidden/Templates/UnlitClipspace" /*end*/
{
	Properties
	{
		/*ase_props*/
		...
		*/
		...
		Pass
		{
			...
			v2f vert ( appdata v /*ase_vert_input*/)
			{
				...
				v.vertex.xyz += vertexValue;
				#endif
				float4 vertexOverride = /*ase_vert_out:Vertex Override;Float4*/float4(0,0,0,1)/*end*/;
				float vertexOverrideBlend = /*ase_vert_out:Vertex Override Blend;Float*/0/*end*/;
