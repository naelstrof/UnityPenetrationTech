Shader /*ase_name*/ "Hidden/Universal/UnlitClipspace" /*end*/
{
	Properties
	{
		/*ase_props*/
		...
		*/
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v /*ase_vert_input*/ )
			{
				...
				float4 vertexOverride = /*ase_vert_out:Clip Vertex Override;Float4*/float4(0,0,0,0)/*end*/;
				float vertexOverrideBlend = /*ase_vert_out:Clip Vertex Override Blend;float*/0/*end*/;
