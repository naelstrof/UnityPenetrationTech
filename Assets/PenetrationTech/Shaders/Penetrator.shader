...
Shader "PenetrationTech/Standard/Penetrator"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			#else
				float3 staticSwitch390_g979 = ( VertexPosition254_g979 + ( SquishDelta85_g979 * temp_output_94_0_g979 * saturate( -_PenetratorSquishPullAmount ) ) + ( temp_output_94_0_g979 * PullDelta91_g979 * saturate( _PenetratorSquishPullAmount ) ) + ( sqrt( ( 1.0 - ( temp_output_1_0_g1009 * temp_output_1_0_g1009 ) ) ) * CumDelta90_g979 * _PenetratorCumActive ) );
			#endif
			...
			#endif
			float temp_output_42_0_g1020 = staticSwitch197_g979;
			float temp_output_26_0_g1021 = temp_output_42_0_g1020;
			float temp_output_19_0_g1021 = ( 1.0 - temp_output_26_0_g1021 );
			float3 temp_output_8_0_g1020 = OrifacePosition170_g979;
			...
			float3 temp_output_9_0_g1020 = OrifaceOutPosition1183_g979;
			...
			float3 temp_output_10_0_g1020 = OrifaceOutPosition2182_g979;
			...
			float3 temp_output_11_0_g1020 = OrifaceOutPosition3175_g979;
			float temp_output_1_0_g1023 = temp_output_42_0_g1020;
			float temp_output_8_0_g1023 = ( 1.0 - temp_output_1_0_g1023 );
			float3 temp_output_3_0_g1023 = temp_output_9_0_g1020;
			...
			float3 temp_output_5_0_g1020 = DickRight184_g979;
			float dotResult15_g1020 = dot( temp_output_2_0_g1020 , temp_output_5_0_g1020 );
			float3 temp_output_65_0_g1020 = cross( normalizeResult29_g1024 , normalizeResult27_g1024 );
			float dotResult18_g1020 = dot( temp_output_2_0_g1020 , temp_output_4_0_g1020 );
			float temp_output_208_0_g979 = saturate( sign( temp_output_152_0_g979 ) );
			float3 lerpResult221_g979 = lerp( ( ( ( temp_output_19_0_g1011 * temp_output_19_0_g1011 * temp_output_19_0_g1011 * temp_output_8_0_g1010 ) + ( temp_output_19_0_g1011 * temp_output_19_0_g1011 * 3.0 * temp_output_26_0_g1011 * temp_output_9_0_g1010 ) + ( 3.0 * temp_output_19_0_g1011 * temp_output_26_0_g1011 * temp_output_26_0_g1011 * temp_output_10_0_g1010 ) + ( temp_output_26_0_g1011 * temp_output_26_0_g1011 * temp_output_26_0_g1011 * temp_output_11_0_g1010 ) ) + ( temp_output_65_22_g1010 * dotResult15_g1010 ) + ( temp_output_65_0_g1010 * dotResult18_g1010 ) ) , ( ( ( temp_output_19_0_g1021 * temp_output_19_0_g1021 * temp_output_19_0_g1021 * temp_output_8_0_g1020 ) + ( temp_output_19_0_g1021 * temp_output_19_0_g1021 * 3.0 * temp_output_26_0_g1021 * temp_output_9_0_g1020 ) + ( 3.0 * temp_output_19_0_g1021 * temp_output_26_0_g1021 * temp_output_26_0_g1021 * temp_output_10_0_g1020 ) + ( temp_output_26_0_g1021 * temp_output_26_0_g1021 * temp_output_26_0_g1021 * temp_output_11_0_g1020 ) ) + ( temp_output_65_22_g1020 * dotResult15_g1020 ) + ( temp_output_65_0_g1020 * dotResult18_g1020 ) ) , temp_output_208_0_g979);
			float3 temp_output_42_0_g1015 = DickForward18_g979;
			float NonVisibleLength165_g979 = ( temp_output_11_0_g979 * _PenetratorLength );
			float3 temp_output_52_0_g1015 = ( ( temp_output_42_0_g1015 * ( ( NonVisibleLength165_g979 - OrifaceLength34_g979 ) - DickLength19_g979 ) ) + ( originalPosition126_g979 - DickOrigin16_g979 ) );
			float dotResult53_g1015 = dot( temp_output_42_0_g1015 , temp_output_52_0_g1015 );
			float temp_output_1_0_g1017 = 1.0;
			float temp_output_8_0_g1017 = ( 1.0 - temp_output_1_0_g1017 );
			float3 temp_output_3_0_g1017 = OrifaceOutPosition1183_g979;
			float3 temp_output_4_0_g1017 = OrifaceOutPosition2182_g979;
			float3 temp_output_7_0_g1016 = ( ( 3.0 * temp_output_8_0_g1017 * temp_output_8_0_g1017 * ( temp_output_3_0_g1017 - OrifacePosition170_g979 ) ) + ( 6.0 * temp_output_8_0_g1017 * temp_output_1_0_g1017 * ( temp_output_4_0_g1017 - temp_output_3_0_g1017 ) ) + ( 3.0 * temp_output_1_0_g1017 * temp_output_1_0_g1017 * ( OrifaceOutPosition3175_g979 - temp_output_4_0_g1017 ) ) );
			float3 normalizeResult27_g1018 = normalize( temp_output_7_0_g1016 );
			...
			float dotResult55_g1015 = dot( temp_output_43_0_g1015 , temp_output_52_0_g1015 );
			float3 temp_output_85_22_g1015 = normalizeResult29_g1018;
			float temp_output_222_0_g979 = saturate( sign( ( temp_output_157_0_g979 - 1.0 ) ) );
			float3 lerpResult224_g979 = lerp( lerpResult221_g979 , ( ( ( dotResult53_g1015 * temp_output_85_23_g1015 ) + ( dotResult54_g1015 * temp_output_85_0_g1015 ) + ( dotResult55_g1015 * temp_output_85_22_g1015 ) ) + OrifaceOutPosition3175_g979 ) , temp_output_222_0_g979);
			#ifdef _CLIP_DICK_ON
			...
			float3 temp_output_21_0_g1020 = VertexNormal259_g979;
			float dotResult55_g1020 = dot( temp_output_21_0_g1020 , temp_output_3_0_g1020 );
			float dotResult56_g1020 = dot( temp_output_21_0_g1020 , temp_output_4_0_g1020 );
			float dotResult57_g1020 = dot( temp_output_21_0_g1020 , temp_output_5_0_g1020 );
			float3 normalizeResult31_g1020 = normalize( ( ( dotResult55_g1020 * normalizeResult27_g1024 ) + ( dotResult56_g1020 * temp_output_65_0_g1020 ) + ( dotResult57_g1020 * temp_output_65_22_g1020 ) ) );
			float3 lerpResult227_g979 = lerp( normalizeResult31_g1010 , normalizeResult31_g1020 , temp_output_208_0_g979);
			float3 temp_output_24_0_g1015 = VertexNormal259_g979;
			float dotResult61_g1015 = dot( temp_output_42_0_g1015 , temp_output_24_0_g1015 );
			float dotResult62_g1015 = dot( temp_output_4_0_g1015 , temp_output_24_0_g1015 );
			float dotResult60_g1015 = dot( temp_output_43_0_g1015 , temp_output_24_0_g1015 );
			float3 normalizeResult33_g1015 = normalize( ( ( dotResult61_g1015 * temp_output_85_23_g1015 ) + ( dotResult62_g1015 * temp_output_85_0_g1015 ) + ( dotResult60_g1015 * temp_output_85_22_g1015 ) ) );
			float3 lerpResult233_g979 = lerp( lerpResult227_g979 , normalizeResult33_g1015 , temp_output_222_0_g979);
			#ifdef _CLIP_DICK_ON
