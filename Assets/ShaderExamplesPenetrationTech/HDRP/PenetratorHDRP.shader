...
Shader "PenetrationTech/HDRP/Penetrator"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3x3 ChangeOfBasis9_g6( float3 right, float3 up, float3 forward )
			{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float localToCatmullRomSpace_float56_g6 = ( 0.0 );
				float3 worldDickRootPos56_g6 = _DickRootWorld;
				float3 right9_g6 = _DickRightWorld;
				float3 up9_g6 = _DickUpWorld;
				float3 forward9_g6 = _DickForwardWorld;
				float3x3 localChangeOfBasis9_g6 = ChangeOfBasis9_g6( right9_g6 , up9_g6 , forward9_g6 );
				float4 appendResult67_g6 = (float4(inputMesh.positionOS , 1.0));
				float4 transform66_g6 = mul(GetObjectToWorldMatrix(),appendResult67_g6);
				transform66_g6.xyz = GetAbsolutePositionWS((transform66_g6).xyz);
				float3 temp_output_68_0_g6 = (transform66_g6).xyz;
				float3 temp_output_12_0_g6 = mul( localChangeOfBasis9_g6, ( temp_output_68_0_g6 - _DickRootWorld ) );
				float3 break15_g6 = temp_output_12_0_g6;
				float temp_output_18_0_g6 = ( break15_g6.z * _SquashStretchCorrection );
				float3 appendResult26_g6 = (float3(break15_g6.x , break15_g6.y , temp_output_18_0_g6));
				float3 appendResult25_g6 = (float3(( break15_g6.x / _SquashStretchCorrection ) , ( break15_g6.y / _SquashStretchCorrection ) , temp_output_18_0_g6));
				float temp_output_17_0_g6 = ( _DistanceToHole * 0.5 );
				float smoothstepResult23_g6 = smoothstep( 0.0 , temp_output_17_0_g6 , temp_output_18_0_g6);
				float smoothstepResult22_g6 = smoothstep( _DistanceToHole , temp_output_17_0_g6 , temp_output_18_0_g6);
				float3 lerpResult31_g6 = lerp( appendResult26_g6 , appendResult25_g6 , min( smoothstepResult23_g6 , smoothstepResult22_g6 ));
				float3 lerpResult32_g6 = lerp( lerpResult31_g6 , ( temp_output_12_0_g6 + ( ( _DistanceToHole - ( _DickWorldLength * ( _DistanceToHole / ( _SquashStretchCorrection * _DickWorldLength ) ) ) ) * float3(0,0,1) ) ) , step( _DistanceToHole , temp_output_18_0_g6 ));
				float3 newPosition44_g6 = ( _DickRootWorld + mul( transpose( localChangeOfBasis9_g6 ), lerpResult32_g6 ) );
				float3 worldPosition56_g6 = newPosition44_g6;
				float3 worldDickForward56_g6 = _DickForwardWorld;
				float3 worldDickUp56_g6 = _DickUpWorld;
				float3 worldDickRight56_g6 = _DickRightWorld;
				float4 appendResult86_g6 = (float4(inputMesh.normalOS , 0.0));
				float3 normalizeResult87_g6 = normalize( (mul( GetObjectToWorldMatrix(), appendResult86_g6 )).xyz );
				float3 worldNormal56_g6 = normalizeResult87_g6;
				float4 break93_g6 = inputMesh.tangentOS;
				float4 appendResult89_g6 = (float4(break93_g6.x , break93_g6.y , break93_g6.z , 0.0));
				float3 normalizeResult91_g6 = normalize( (mul( GetObjectToWorldMatrix(), appendResult89_g6 )).xyz );
				float4 appendResult94_g6 = (float4(normalizeResult91_g6 , break93_g6.w));
				float4 worldTangent56_g6 = appendResult94_g6;
				...
				float4 transform72_g6 = mul(GetWorldToObjectMatrix(),localWorldVar72_g6);
				
				float4 appendResult75_g6 = (float4(worldNormalOUT56_g6 , 0.0));
				float3 normalizeResult76_g6 = normalize( (mul( GetWorldToObjectMatrix(), appendResult75_g6 )).xyz );
				...
				#endif
				float3 vertexValue = (transform72_g6).xyz;
				...
				inputMesh.normalOS = normalizeResult76_g6;
						...
						)
			{
				...
				float4 appendResult67_g6 = (float4(packedInput.ase_texcoord6.xyz , 1.0));
				float4 transform66_g6 = mul(GetObjectToWorldMatrix(),appendResult67_g6);
				transform66_g6.xyz = GetAbsolutePositionWS((transform66_g6).xyz);
				float3 temp_output_68_0_g6 = (transform66_g6).xyz;
				float dotResult42_g6 = dot( _DickForwardWorld , ( temp_output_68_0_g6 - _DickRootWorld ) );
				
				surfaceDescription.Albedo = tex2DNode31.rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), 1.0f );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = tex2DNode33.r;
				...
				surfaceDescription.Smoothness = tex2DNode33.a;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = ( tex2DNode31.a * ( 1.0 - ( step( _StartClip , dotResult42_g6 ) * step( dotResult42_g6 , _EndClip ) ) ) );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 appendResult67_g6 = (float4(packedInput.ase_texcoord1.xyz , 1.0));
				float4 transform66_g6 = mul(GetObjectToWorldMatrix(),appendResult67_g6);
				transform66_g6.xyz = GetAbsolutePositionWS((transform66_g6).xyz);
				float3 temp_output_68_0_g6 = (transform66_g6).xyz;
				float dotResult42_g6 = dot( _DickForwardWorld , ( temp_output_68_0_g6 - _DickRootWorld ) );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 normalizeResult87_g6 = normalize( (mul( GetObjectToWorldMatrix(), appendResult86_g6 )).xyz );
				float3 worldNormal56_g6 = normalizeResult87_g6;
				float4 break93_g6 = inputMesh.ase_tangent;
				float4 appendResult89_g6 = (float4(break93_g6.x , break93_g6.y , break93_g6.z , 0.0));
				float3 normalizeResult91_g6 = normalize( (mul( GetObjectToWorldMatrix(), appendResult89_g6 )).xyz );
				float4 appendResult94_g6 = (float4(normalizeResult91_g6 , break93_g6.w));
				float4 worldTangent56_g6 = appendResult94_g6;
					...
					)
			{
				...
				float4 tex2DNode31 = tex2D( _BaseColorMap, uv_BaseColorMap );
				float4 appendResult67_g6 = (float4(packedInput.ase_texcoord2.xyz , 1.0));
				float4 transform66_g6 = mul(GetObjectToWorldMatrix(),appendResult67_g6);
				transform66_g6.xyz = GetAbsolutePositionWS((transform66_g6).xyz);
				float3 temp_output_68_0_g6 = (transform66_g6).xyz;
				float dotResult42_g6 = dot( _DickForwardWorld , ( temp_output_68_0_g6 - _DickRootWorld ) );
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode31 = tex2D( _BaseColorMap, uv_BaseColorMap );
				float4 appendResult67_g6 = (float4(packedInput.ase_texcoord4.xyz , 1.0));
				float4 transform66_g6 = mul(GetObjectToWorldMatrix(),appendResult67_g6);
				transform66_g6.xyz = GetAbsolutePositionWS((transform66_g6).xyz);
				float3 temp_output_68_0_g6 = (transform66_g6).xyz;
				float dotResult42_g6 = dot( _DickForwardWorld , ( temp_output_68_0_g6 - _DickRootWorld ) );
		...
		Pass
		{
						...
						)
			{
				...
				float4 appendResult67_g6 = (float4(packedInput.ase_texcoord8.xyz , 1.0));
				float4 transform66_g6 = mul(GetObjectToWorldMatrix(),appendResult67_g6);
				transform66_g6.xyz = GetAbsolutePositionWS((transform66_g6).xyz);
				float3 temp_output_68_0_g6 = (transform66_g6).xyz;
				float dotResult42_g6 = dot( _DickForwardWorld , ( temp_output_68_0_g6 - _DickRootWorld ) );
...
/*ASEBEGIN
Version=18912
601;201;1772;924;739.3798;300.4005;1.763971;True;False
...
WireConnection;184;1;32;0
WireConnection;184;4;33;1
WireConnection;184;7;33;4
WireConnection;184;9;96;0
WireConnection;184;10;97;0
WireConnection;184;11;197;61
WireConnection;184;12;197;62
ASEEND*/
//CHKSM=C856EBB4A1D0CB0E871D93960A3793F98A09BC17